...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" prefix="og: http://ogp.me/ns#">
    <head>
        <title>Events — Jugend Rettet</title>
...
Wir freuen uns, euch dort zu sehen!<br>
Euer Jugend Rettet Team</p><br>
                        -->
                        <div class="event-container">
                    ...
                    <div class="date-container" id="13-11-2015">
                        ...
                        <p>Wir werden das Projekt, das Team und unseren aktuellen Arbeitsstand vorstellen. Besonders wichtig ist die Suche nach weiteren Unterstützer_innen.</p><br>
                        <p>Auch für vegane Snacks ist gesorgt.</p><br>
                    ...
                    <div class="date-container" id="26-11-2015">
                        <h4>Invitation to the Open Meeting in Trier</h4><br>
                    ...
                    <div class="date-container" id="30-11-2015">
                        <h4>Invitation to the Open Meeting in Baiz Berlin</h4><br>
                    ...
                    <div class="date-container" id="08-12-2015">
                        <h4>Invitation to the first Open Meeting in Nürnberg</h4><br>
                    ...
                    <div class="date-container" id="09-12-2015">
                        <h4>Invitation to First open meeting in English - Fehre6 Berlin</h4><br>
                    ...
                    <div class="date-container" id="19-01-2016">
                        <h4>Cancelled! (Invitation to open meeting in Kiel)</h4>
                        <br>
                        <p>Unfortunately the event had to be cancelled.</p>
                        <br>
                        <p>Your Jugend Rettet Team</p><br>
                        <br>
                        <div class="event-container">
