                    ...
                    <div style="margin-right:10px" class="column">
                        ...
                        <div id="rechner">
                            ...
                            <div id="spendentext" style="display:none">
                                ...
                                <p id="text-schiffsteil-prozent">With your <b class="EUR"></b> <b>€</b> a total of <b id="prozent"></b> <b>%</b> would be added to our next need – radios.</p>
                                <p id="text-schiffsteil-komplett">With your <b class="EUR"></b> <b>€</b> our next need – radios – would be completed!</p>
                    ...
                    <div class="column hideme" style="min-width: 300px;">
                        ...
                        <div id="schiff-ani">
                            ...
                            <div id=schiff-container style="min-height:133px;width:300px;">
                                ...
                                <div class="blink balken" id="schiff-gespendet" style="position:absolute;overflow:hidden;width:calc(300px * 51026 / 80000);">
                                ...
                                <div style="position:absolute;width:300px">
                                    <!--<span id="0" class="unterteilungen">0m</span>-->
                                    <span id="stand" class="spendenstand schiff" style="white-space: nowrap;position:absolute;left: calc(-15px + 300px*51026/80000)">51 Tsd. €</span>
                                </div>
                            </div>
                        </div>
                        <br><br>
